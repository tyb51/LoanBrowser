        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              For loans with insurance, please use a <a href="/cases" className="font-medium text-blue-800 underline">Case</a> where you can create insurance simulations and include them in your loan calculations.
            </p>
          </div>
        </div>
      </div>
